    ...
    <div className="app-container animate-fade-in">
      ...
      <main className="main-content flex-layout animate-slide-up">
        ...
        <aside className="sidebar right-sidebar">
          ...
          {/* Wall Color Picker with Hex Input */}
          <div className="color-picker-wrapper glass-panel flex-col-full">
            <div className="flex-row-center w-full gap-2">
              <Pipette size={18} className="icon-normal" />
              <span className="color-picker-label">Wall Color</span>
            </div>
            
            <div className="flex-row-center w-full gap-2">
              <div className="color-indicator-large relative-container">
                <input 
                  type="color" 
                  value={wallColor}
                ...
                />
                <div className="bg-fill pointer-events-none" style={{ backgroundColor: wallColor }} />
              </div>
              <input 
                type="text" 
                value={wallColor}
